...
export default function WhatsAppFloatingButton({ 
  lang = 'en',
  phoneNumber = BRAND?.whatsappNumber || '919929922469',
  predefinedMessage = 'Namaste Siva Kaveri Chits, I would like to inquire about chit schemes.'
}) {
  const [isHovered, setIsHovered] = useState(false);

  const handleClick = () => {
    const text = encodeURIComponent(predefinedMessage);
