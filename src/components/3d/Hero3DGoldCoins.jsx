...
function Volumetric3DCoin({
  ...
  parallaxFactor = 0.06,
  mousePos = { x: 0, y: 0 },
  frontImg = '/assets/coins/coin_rupee.webp',
  backImg = '/assets/coins/coin_lakshmi.webp',
...
export default function Hero3DGoldCoins() {
  ...
  const coins = [
    ...
    },
    {
      ...
      parallaxFactor: 0.1,
      frontImg: '/assets/coins/coin_lakshmi.webp',
      backImg: '/assets/coins/coin_rupee.webp',
